...
stateDiagram-v2
    ...
    note right of new : при старте субагента этап в new; исполнение задачи — после in-progress
